...
const Header: React.FC = () => (
  <header className="sticky top-0 z-30 backdrop-blur supports-[backdrop-filter]:bg-slate-900/60 bg-slate-900/90 border-b border-white/10">
    <Section className="flex items-center justify-between py-3">
      ...
      <a
        href="https://Odyssi.tech"
        className="rounded-xl bg-white text-gray-900 px-4 py-2 text-sm font-semibold hover:bg-gray-100"
      >
        Open App
      </a>
    </Section>
    ...
    >
      <div>
        ...
        <p className="mt-4 text-white/70 leading-relaxed">
          Capture routes, notes, photos, and thoughts anywhere — even with zero
          signal. Odyssi keeps your data on-device by default, then syncs when
          you choose.
        </p>
        ...
        <div className="mt-6 flex flex-wrap gap-5 text-xs text-white/60">
          <span className="inline-flex items-center gap-2">
            <CloudOff className="size-4" /> Works offline
          </span>
          <span className="inline-flex items-center gap-2">
            <Lock className="size-4" /> Local-first privacy
          </span>
          <span className="inline-flex items-center gap-2">
            <Smartphone className="size-4" /> Mobile-ready
          </span>
        </div>
      </div>
      <motion.div
          ...
          <div className="grid h-full grid-cols-3 gap-3">
            <div className="col-span-2 rounded-2xl border border-white/10 bg-black/30 p-4">
              <div className="flex items-center gap-2 text-sm text-white/70">
                <MapPin className="size-4" /> Map View
              </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-black/30 p-4">
              ...
              <div className="mt-3 flex items-center gap-2 text-white/70 text-xs">
                <Camera className="size-4" /> Photo Pin
              </div>
            </div>
          </div>
        </div>
